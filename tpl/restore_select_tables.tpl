...
<div id="content">
	<form name="frm_tbl" action="filemanagement.php" method="post" onSubmit="return chkFormular()">
		<div>
			<input type="button" class="Formbutton" onclick="Sel(true);" value="{L_SELECT_ALL}">
			<input type="button" onclick="Sel(false);" value="{L_DESELECT_ALL}" class="Formbutton">
			<input type="submit" class="Formbutton" name="{BUTTON_NAME}" value="{L_START_RESTORE}" onclick="if (!confirm('{L_CONFIRM_RESTORE}')){return false;}">
		</div>
		<br>
		<table class="bdr">
			<tr class="thead">
		...
		<div>
			<input type="button" class="Formbutton" onclick="Sel(true);" value="{L_SELECT_ALL}">
			<input type="button" onclick="Sel(false);" value="{L_DESELECT_ALL}" class="Formbutton">
			<input type="submit" class="Formbutton" name="{BUTTON_NAME}" value="{L_START_RESTORE}">
		</div>
		<br>
		<br>
		<br>
