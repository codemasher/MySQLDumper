...
function TesteSFTP($i){
	...
	if($config['sftp_timeout'][$i] == '' || $config['sftp_timeout'][$i] == 0){
		$config['sftp_timeout'][$i] = 30;
	}
	if($config['sftp_port'][$i] == '' || $config['sftp_port'][$i] == 0){
		$config['sftp_port'][$i] = 22;
	}
	if($config['sftp_path_to_private_key'][$i] == '' || $config['sftp_path_to_private_key'][$i] == 0){
		$config['sftp_path_to_private_key'][$i] = null;
	}
	if($config['sftp_secret_passphrase_for_private_key'][$i] == '' || $config['sftp_secret_passphrase_for_private_key'][$i] == 0){
		$config['sftp_secret_passphrase_for_private_key'][$i] = null;
	}
	if($config['sftp_fingerprint'][$i] == '' || $config['sftp_fingerprint'][$i] == 0){
