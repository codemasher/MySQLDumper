<div id="content">
	...
	Daniel Schlichtholz hade iden för detta projekt.<p>2004 startade han forumet
		<a href="http://forum.mysqldumper.de" target="_blank">MySQLDumper</a> och väldigt snabbt infann sig ett antal hobby-programmerare som skrev nya skripter och anpassade de skripter som Daniel hade skrivit.<br>På kortaste tid uppstod ett omfångsrikt projekt.
	<p>Välkommen att yttra dina förbättringsförslag i MySQLDumper-forumet
		<a href="http://forum.mysqldumper.de" target="_blank">http://forum.mysqldumper.de</a>.
	<p>Vi önskar mycket nytta och nöje med detta projekt.<br>
	<p><h4>MySQLDumper-teamet</h4>
	...
	<ul>
		...
		<ul><br>
			<li>
				<a name="conf1"></a><strong>Konfigurerade databaser:</strong> en lista över konfigurerade databaser. Den aktiva databasen visas med
				<b>fet</b> text.
			</li>
			<li>
				<a name="conf2"></a><strong>Tabell-prefix:</strong> här kan du ange ett prefix (för varje databas). Detta är ett filter som filtrar ut tabeller som börjar med detta prefix (t.ex. alla tabeller som börjar med "phpBB_") när en dump görs. Lämna fältet tomt om alla tabeller skall sparas.
			</li>
			<li>
				<a name="conf3"></a><strong>GZip-komprimering:</strong> här kan du aktivera komprimeringen. Vi rekommenderar att komprimering aktiveras eftersom filerna blir mycket mindre och platsen på hårddisken är dyr.
			</li>
			<li>
				<a name="conf5"></a><strong>Email med dump-filen:</strong> om denna option aktiveras så sänds den färdiga dumpen som email-attachment (VARNING: aktivera ovillkorligen kompression, annars kan attachmentet blir för stort och kan eventuellt ej skickas!).
			</li>
			...
			<li>
				<a name="conf13"></a><strong>FTP-överföring:</strong> om denna option aktiveras så överförs den färdiga dumpen via FTP.
			</li>
			...
			<li>
				<a name="conf18"></a><strong>FTP upload-mapp:</strong> mappen i vilken backup-filen skall sparas (servern måste tillåtas skriva till denna mapp!).
			</li>
			<li>
				<a name="conf8"></a><strong>Automatisk radering av backup:</strong> om denna option aktiveras så raderas äldre backup-filer automatiskt enligt följande regler.
			</li>
			<li>
				<a name="conf10"></a><strong>Antal backup-filer:</strong> ett värde > 0 raderar alla filer utöver antalet i detta värde.
			</li>
		...
		<UL>
			...
			<li>
				<strong>Starta ny backup:</strong> med denna funktion startar du en ny backup (dump) i enlighet med de parametrar som ställts in i konfigureringen.
			</li>
		</UL>
