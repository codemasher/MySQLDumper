<div id="content">
	...
	<p>Se hai proposte di miglioramento rivolgiti al MySQLDumper-Forum:
		<a href="http://forum.mysqldumper.de" target="_blank">http://forum.mysqldumper.de</a>
	<p>Ti auguriamo buon divertimento con questo progetto.<br>
	<p><h4>Il Team di MySQLDumper</h4>
	<table>
		<tr>
			<td><img src="images/logo.gif" alt="MySQLDumper"
			         width="160" height="42" border="1"></td>
			<td valign="top">
				Daniel Schlichtholz
			</td>
		</tr>
	...
	<ul>
		...
		<ul><br>
			<li>
				<a name="conf1"></a><strong>Banca dati configurata:</strong> la lista delle banche dati configurati. La banca dati attiva viene visualizata in
				<b>bold</b>.
			</li>
			<li>
				<a name="conf2"></a><strong>Prefix-tabelle:</strong> qui potete (per ogni banca dati) mettere un prefix.Questo è un filtro che nel Dumps viene considerato solo nelle tabelle con il prefix (esempio: tutte le tabelle che cominciano con "phpBB_" ). Se volete salvare tutta la banca dati lasciate libera questa casella.
			</li>
			<li>
				<a name="conf3"></a><strong>compressione-GZip:</strong> Qui potete selezionare la compressione. È consigliato selezionare questa opzione, perche cosi i dati vengono ristretti per risparmiare spazio sul disco rigido .
			</li>
			<li>
				<a name="conf5"></a><strong>Email con Dumpfile:</strong> Se avete selezionato questa opzione viene spedita una e-mail con allegato dopo il backup(attenzione, la compressione in questo caso e consigliata, altrimenti la e-mail non potrebbe essere spedita!)
			</li>
			<li><a name="conf6"></a><strong>Indrizzo-e-mail:</strong> Mittente della e-mail</li>
			<li>
				<a name="conf7"></a><strong>Destinatario della e-mail:</strong> questo indrizzo e visibile nella e-mail come destinatario
			</li>
			<li>
				<a name="conf13"></a><strong>FTP-Transfer: </strong>Se è selezionata questa opzione, al termine del backup viene spedito il dato tramite FTP.
			</li>
			...
			<li>
				<a name="conf18"></a><strong>FTP cartella - upload: </strong>l`elenco in cui viene spedito il dato del backup (dovete avere il permesso per scaricare (upload)!)
			</li>
			<li><a name="conf8"></a><strong>Cancellare automaticamente i backups:</strong>
				Quando è selezionata questa opzione vengono cancellati automaticamente i backups piu vecchi..
			</li>
			<li>
				<a name="conf10"></a><strong>Quantità dei dati backup:</strong> Un valore > 0 cancella tutti i backup, fino al valore selezionato
			</li>
