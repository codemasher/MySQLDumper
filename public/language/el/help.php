<div id="content">
	...
	Η ιδέα για το εργαλείο αυτό είναι του Daniel Schlichtholz.<p>Το 2004 δημιούργησε ένα φόρουμ με όνομα
		<a href="http://forum.mysqldumper.de" target="_blank">MySQLDumper</a> και σύντομα, προγραμματιστές που ασχολούνται με νέα σκριπτ, ενίσχυσαν τα σκριπτ του Daniel.<br>Μέσα σε λίγο καιρό το μικρό του προγραμματάκι μετατράπηκε σε ένα σταθερότατο εργαλείο.
	<p>Εαν έχετε ιδέες για βελτίωση επισκευθείτε το φόρουμ του MySQLDumper:
		<a href="http://forum.mysqldumper.de" target="_blank">http://forum.mysqldumper.de</a>.
	<p>Σας ευχόμαστε ατελείωτα αντίγραφα ασφαλείας με αυτό το εργαλείο.<br><br><h4>Η ομάδα του MySQLDumper</h4>
	<table>
		<tr>
	...
	<ul>
		...
		<ul>
			<li>
				<a name="conf1"><strong>Λίστα Β.Δεδομένων:</strong> Η λίστα των Β.Δεδομένων σας. Η ενεργή Β.Δεδομένων είναι έντονη.
			</li>
			<li>
				<a name="conf2"><strong>Πρόθεμα πίνακα:</strong> Εδώ επιλέγετε ένα πρόθεμα πίνακα για κάθε Β.Δεδομένων χωριστά. Το πρόθεμα είναι ένα φίλτρο, που διαχειρίζεται τους πίνακες σε ένα αντίγραφο ασφαλείας, που ξεκινάει με αυτό το πρόθεμα (π.χ. όλοι οι πίνακες ξεκινούν με "phpBB_"). Εαν δε θέλετε να το χρησιμοποιήσετε, αφήστε το πεδίο κενό.
			</li>
			<li>
				<a name="conf3"><strong>Συμπίεση GZip:</strong> Εδώ ενεργοποιείτε τη συμπίεση. Προτείνεται να εργάζεστε με την συμπίεση ενεργοποιημένη, για μικρότερο μέγεθος αρχείων, ώστε να μην πιάνουν πολύ χώρο στο δίσκο.
			</li>
			<li>
				<a name="conf19"></a><strong>Αριθμός εγγραφών για αντίγραφα ασφαλείας:</strong> Ο αριθμός των εγγραφών που διαβάζονται ταυτόχρονα κατά τη λειτουργία αντιγράφων ασφαλείας, πριν το script κάνει callback. Για αργούς διακομιστές μειώστε την παράμετρο για να αποφύγετε timeouts.
			</li>
			<li>
				<a name="conf20"></a><strong>Αριθμός εγγραφών για επαναφορά:</strong> Ο αριθμός των εγγραφών που διαβάζονται ταυτόχρονα κατά την επαναφορά, πριν το script κάνει callback. Για αργούς διακομιστές μειώστε την παράμετρο για να αποφύγετε timeouts.
			</li>
			<li>
				<a name="conf4"></a><strong>Κατάλογος για τα αρχεία αντιγράφων ασφαλείας:</strong> επιλέξτε τον κατάλογο για τα αντίγραφα ασφαλείας. Εάν επιλέξετε έναν νέο, Το script θα τον δημιουργήσει για σας. Μπορείτε να χρησιμοποιήσετε σχετικές ή απόλυτες διαδρομές.
			</li>
			<li>
				<a name="conf5"></a><strong>Αποστολή Αντιγράφου ασφαλείας ως email:</strong> Οταν έχετε αυτή την επιλογή, το script θα στείλει αυτόματα το ολοκληρωμένο αντίγραφο ασφαλείας μέσω email με συννημένο (Προσέξτε!, πρέπει να χρησιμοποιείτε συμπίεση με αυτή την επιλογή επειδή το αντίγραφο ασφαλείας μπορεί να είναι τεράστιο για email!)
			</li>
			...
			<li>
				<a name="conf13"></a><strong>Μεταφορά FTP: </strong>Οταν έχετε αυτή την επιλογή, το script θα στείλει αυτόματα το ολοκληρωμένο αντίγραφο ασφαλείας μέσω FTP.
			</li>
			...
			<li>
				<a name="conf18"></a><strong>Κατάλογος φόρτωσης FTP: </strong>Ο κατάλογος που αποθηκεύονται τα αντίγραφα ασφαλείας (πρέπει να έχει δικαιώματα για φόρτωση!)
			</li>
		...
		<UL>
			...
			<li>
				<strong>Νέο αντίγραφο ασφαλείας:</strong> εδώ μπορείτε να ξεκινήσετε ένα νέο αντίγραφο ασφαλείας (dump) με τις περαμέτρους που έχετε ορίσει.
			</li>
		</UL>
