<div id="content">
	...
	Idéen til dette projekt kommer fra Daniel Schlichtholz.<p>I 2004 skabte han et forum kaldet
		<a href="http://forum.mysqldumper.de" target="_blank">MySQLDumper</a> og programmører af andre programmer supplementerede Daniel's scripts.<br>I løbet af kort tid blomstrede det lille backup-script til et langt større projekt.
	<p>Hvis du har forslag til forbedringer kan du besøge MySQLDumper-Forum:
		<a href="http://forum.mysqldumper.de" target="_blank">http://forum.mysqldumper.de</a>.
	<p>God fornøjelse med at bruge systemet.<br><br><h4>MySQLDumper-Teamet</h4>
	<table>
		<tr>
	...
	<ul>
		...
		<ul>
			<li>
				<a name="conf1"><strong>Konfigurerede Databaser:</strong> liste over konfigurerede databaser. Den aktive database er markeret fremhøvet.
			</li>
			<li>
				<a name="conf2"><strong>Tabel-Præfiks:</strong> du kan vælge et præfiks for hver database for sig. Præfikset er et filter, der kun håndterer de tabeller i et dump, som starter med dette præfiks (f.eks. alle tabeller startende med "phpBB_"). Hvis du ikke ønsker at bruge det, lad feltet være tomt.
			</li>
			<li>
				<a name="conf3"><strong>GZip-komprimering:</strong> Her kan du aktivere komprimering. Det anbefales at bruge komprimering grundet den mindre filstørrelse som dermed sluger mindre diskplads.
			</li>
			<li>
				<a name="conf19"></a><strong>Antal poster til backup:</strong> Dette er antallet af poster der læses samtidigt under backup, før scriptet kaldes igen. For langsommere servere kan du reducere dette parameter for at forhindre timeouts.
			</li>
			<li>
				<a name="conf20"></a><strong>Antal poster til genetablering:</strong> Dette er antallet af poster der læses samtidigt under backup, før scriptet kaldes igen. For langsommere servere kan du reducere dette parameter for at forhindre timeouts.
			</li>
			<li>
				<a name="conf4"></a><strong>Folder for Backupfiler:</strong> vælg din folder til backupfilerne. Hvis du vælger en ny, opretter scriptet den for dig. Du kan bruge relative eller absolutte stier.
			</li>
			<li>
				<a name="conf5"></a><strong>Send dumpfil som email:</strong> Når denne indstilling er slået til, vil scriptet automatisk sende den færdige backupfil som en email med vedhæftet fil (Forsigtig!, du bør bruge komprimering med denne indstilling da dumpfilen kan være for stor til email!)
			</li>
			...
			<li>
				<a name="conf13"></a><strong>FTP-overførsel: </strong>Når denne indstilling er slået til sender scriptet automatisk den færdige backupfil via FTP.
			</li>
			...
			<li>
				<a name="conf18"></a><strong>FTP Upload-folder: </strong>folderen hvori backupfilen gemmes (der skal være skrive-rettigheder til folderen!)
			</li>

			<li>
				<a name="conf8"></a><strong>Automatisk sletning af backups:</strong> Når du aktiverer denne indstilling, slettes backupfiler automatisk efter følgende regler.
			</li>
			<li>
				<a name="conf10"></a><strong>Slet ud fra antal filer:</strong> En værdi > 0 sletter alle filer pånær det givne antal
			</li>
