<div id="content">
	...
	D Idee für das Projäkt isch vom Daniel Schlichtholz cho.<p>Er hät 2004 das Forum
		<a href="http://forum.mysqldumper.de" target="_blank">MySQLDumper</a>, eröffnet und scho bald händ sich Hobby-Programmierer, wo neui Skripts schribe und diä vom Daniel erwiteret händ, iigfunde.<br>I kürzischter Ziit isch us däm chline Backupskript es stattlichs Projäkt entschtande.
	<p>Wänn Du Vorschläg zur Verbesserig häsch, dänn wänd Di as MySQLDumper-Forum
		<a href="http://forum.mysqldumper.de" target="_blank">http://forum.mysqldumper.de</a>.
	<p>Mir wünsched Dir vill Vergnüege mit däm Projäkt.<br>
	<p><h4>S MySQLDumper-Team</h4>
	...
	<ul>
		...
		<ul><br>
			<li>
				<a name="conf1"></a><strong>Konfigurierti Datebanke:</strong> d Uuflischtig vo de konfigurierte Datebanke. Di aktivi Datebank wird in
				<b>bold</b> gelistet.
			</li>
			<li>
				<a name="conf2"></a><strong>Tabellen-Präfix:</strong> da chönd Ihr (für jedi Datebank) en Präfix aagäh. Das isch en Filter, wo bi Dumps nur diä Tabälle berücksichtigt, wo mit däm Präfix aafanged (z.B. alli Tabälle, wo mit "phpBB_" aafanged). Wänn alli Tabälle vo dere Datebank gspicheret wärden sölled,
				lönd eifach s Fäld läär.
			</li>
			<li>
				<a name="conf3"></a><strong>GZip-Kompression:</strong> Da cha d Kompression aktiviert wärde. Empfehlenswert isch d Aktivierig, will d Dateie wesentlich chliner wärdet und Spicherplatz immer rar isch.
			</li>
			<li>
				<a name="conf5"></a><strong>Email mit Dumpfile:</strong> Isch diä Option aktiviert, wird nach em abgschlossne Backup en Email mit dem Dump als Aahang verschickt (Vorsicht, Kompression sötti umbedingt aa sii, susch wird dr Aahang zgross und cha evtl. nöd verschickt wärde!).
			</li>
			...
			<li>
				<a name="conf13"></a><strong>FTP-Transfer: </strong>Isch diä Option aktiviert, wird nach em abgschlossne Backup d Backupdatei per FTP verschickt.
			</li>
			...
			<li>
				<a name="conf18"></a><strong>FTP Upload-Ordner: </strong>Das Verzeichnis, wo diä Backupdatei häre söll (es müend Upload-Berechtigunge beschtah!).
			</li>
			<li>
				<a name="conf8"></a><strong>Automatisches Lösche vo de Backups:</strong> Wänn diä Option aktiviert isch, wärdet älteri Backups nach de folgende Regle automatisch gelöscht.
			</li>
			<li>
				<a name="conf10"></a><strong>Aazahl vo Backupdateie:</strong> En Wert > 0 löscht alli Backupdateie, bis uf diä da agebni Zahl.
			</li>
		...
		<UL>
			...
			<li>
				<strong>Neues Backup starten:</strong> Da schtartisch es neus Backup (Dump) nach de iigschtellte Parametern i de Konfiguration.
			</li>
		</UL>
