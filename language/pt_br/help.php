<div id="content">
	...
	<p>Em 2004 ele criou um fórum chamado
		<a href="http://forum.mysqldumper.de" target="_blank">MySQLDumper</a> e logo , programadores estavam escrevendo novos scripts, que complementavam os scripts de Daniel.<br>
		Depois de um período curto de tempo um pequeno script de backup tinha se tornado um projeto robusto e avançado.
	<p>Se você tiver alguma sugestão de aperfeiçoamento por favor visite o fórum do MySQLDumper:
	...
	<ul>
		...
		<ul>
			...
			<li>
				<a name="conf3"></a><strong>GZip-Compression:</strong> Aqui você pode ativar a compressão. é recomendável trabalhar com compressão por conta do tamanho dos arquivos: espaço em disco sempre é algo precioso, não é?
			</li>
			<li>
				<a name="conf19"></a><strong>Contagem de Registros para Backup:</strong> Número de registros lidos simultaneamente durante o processo de backup, antes do registro fazer nova chamada. Em servidores lentos você deve reduzir este parâmetro para prevenir timeouts.
			</li>
			<li>
				<a name="conf20"></a><strong>Contagem de Registros para restaurar:</strong> Número de registros lidos simultaneamente durante o processo de restauração, antes do registro fazer nova chamada.Em servidores lentos você deve reduzir este parâmetro para prevenir timeouts
			</li>
			<li>
				<a name="conf4"></a><strong>diretório para arquivos de backup:</strong> escolha seu diretório para os arquivos de backup. Se você quiser criar um, o script irá criar um para você. você pode usar paths relativos ou absolutos.
			</li>
			<li>
				<a name="conf5"></a><strong>Enviar arquivo de backup como e-mail:</strong> Quando esta opção está ativa, o script irá encaminhar automaticamente o arquivo de backup como anexo do e-mail (cuidado!, você deve usar a opção de comprimir os arquivos porquê os arquivos de backup podem ficar muito grandes para serem encaminhados por eamail!
			</li>
			...
			<li>
				<a name="conf13"></a><strong>Transferência por FTP: </strong>Quando esta opção estiver ativa, o script irá, automaticamente, enviar o arquivo de backup via FTP.
			</li>
			...
			<li>
				<a name="conf18"></a><strong>FTP - diretório para upload: </strong>diretório/pasta para salvar os arquivos de backup (tem de ter permissão para upload!)
			</li>

			<li>
				<a name="conf8"></a><strong>Apagar backups automaticamente:</strong> Quando você ativar esta opção os arquivos de backup serão apagados automaticamente segundo as configurações a seguir.
			</li>
