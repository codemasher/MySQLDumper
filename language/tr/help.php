<div id="content">
	...
	Bu projenin kurucusu Daniel Schlichtholz'dur.<p>2004 yilinda
		<a href="http://forum.mysqldumper.de" target="_blank">MySQLDumper panosunu </a>kurdu,
		kisa bir süre sonra baskalari tarafindan destek gördü ve birçok kisinin katilimlari ile yazilim genisletilmeye baslandi.
	<p>istekleriniz veya önerileriniz için
		<a href="http://forum.mysqldumper.de" target="_blank">MySQLDumper-Panosuna</a> katilabilirsiniz.
	<p>
		<br>
	<p><h4>MySQLDumper-Ekibi</h4>
	...
	<ul>
		...
		<ul><br>
			<li><a name="conf1"></a><strong>Veritabanlari:</strong> Veritabanlari Listesi. Aktiv olan Veritabani
				<b>kalin</b> yazilmistir.
			</li>
			<li>
				<a name="conf2"></a><strong>Tablo ön eki:</strong> Burada belirleyeceginiz filtre tedeklenecek tablolarda uygulanacaktir
				(örnegin: "phpBB_" ile baslayan tablolar). Veritabaninin bütün tablolarini yedeklemek istiyorsanin burasini bos birakiniz.
			</li>
			<li>
				<a name="conf3"></a><strong>Sikistirma:</strong> Sikistirmayi burada açabilirsiniz. Sikistirmayi kullanmanizi tavsiye ederiz.
			</li>
			<li>
				<a name="conf5"></a><strong>Yedekleme ekli Mail:</strong> Bu Opsyon kullanildiginda, islemin sonunda gönderilecek mail'e yedekleme dosyasi eklenecektir. Sikistirmanin aktiv olmasini öneririz !).
			</li>
			...
			<li>
				<a name="conf13"></a><strong>FTP-Transferi: </strong>Bu Opsyon kullanildiginda, islem sonunda yedekleme dosyasi FTP ile gönderilir.
			</li>
			...
			<li>
				<a name="conf18"></a><strong>FTP yükleme klasörü: </strong>Yedekleme dosyasinin yüklenecegi klasörün adi. (UYARI: CHMOD ayarlarini göz önünde bulundurunuz).
			</li>
			<li>
				<a name="conf8"></a><strong>Otomatik dosya silme:</strong> Bu Opsyon kullanildiginda, belirlenecek kurallara göre yedekleme dosyalari silinecektir.
			</li>
			<li>
				<a name="conf10"></a><strong>Dosya sayisi:</strong> 0 dan büyük bir deger, bu degeri asan dosya sayisindan fazla olan dosyalari silecektir.
			</li>
			<li><a name="conf11"></a><strong>Dil:</strong> MySQL Dumperin kullanacagi dili burada belirlersiniz.</li>
			<li>
				<a name="conf12"></a><strong>Cronjob zamandilimi:</strong> Saniye olarak belirlenecek deger, Cronjob için geçerli olan süreyi (eger yetkiniz varsa) yükseltmege deger.
			</li>
		</ul>
